...
class Psycho_Killer_Role(Role_AbstClass):
    ...
    def revenge_wolf(self):
        ...
        wolfs = [k for k, v in p_dict.items() if (self.master_.global_object.players[v].role.role_enum is ROLES.WEREWOLF) and self.master_.global_object.players[v].role.try_attack == self.player_.player_name]
